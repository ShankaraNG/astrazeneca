...
def pipelinerun(targetgenelist, exclusiongenelist, diseasename, fusionfilter, mutationfilter):
    try:
        ...
        explanation = ex.generate_explanation(final_top10_df, final_mutated_df, targetgenelist, exclusiongenelist, diseasename, fusionfilter, mutationfilter, llm_callable=None, model='llama3.2:3b', host='http://localhost:11434', save=True)
        ...
        return final_top10_df, explanation, metabolomnic_df, fusion_reference_df, mutation_reference_df, final_mutated_df, kmeansplotforselectedcell
