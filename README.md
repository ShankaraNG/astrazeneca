...
- The raw DepMap / HPA / CCLE data files placed under `data/raw/` as described
...
`knn_data/`, `lookup/`, `mofa_data/`, `scoring/`, `test/` — is **generated by
...
> **Only `data/raw/` is required to start.** Running the offline pipeline
